...
2. Ask the designated independent-review authority to attest implementation owner, independent evaluator, reviewer, and registry custodian. Under frozen v4, the evaluator performs the requested hidden-artifact-provider duty; reject a separate provider/evaluator organization unless an accepted v4 revalidation exists. Record conflicts, qualifications, reporting-line separation, key revocation process, and reviewer authority outside the repository.
