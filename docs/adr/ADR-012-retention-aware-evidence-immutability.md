...
embeddings, indexes, caches, Dreaming snapshots, reports, candidates, decision
packages, and provenance-linked derivatives participate in the authorized
retention, deletion, anonymization, and audit path.
