...
| [ADR-016](ADR-016-hierarchy-catalog-and-operational-memory-scope.md) | Accepted, amended by ADR-018 | Brain-to-Session catalog hierarchy; Goal is a session-bound aggregate |
