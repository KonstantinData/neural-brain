...
| --- | --- | --- | --- | --- |
| Neural cognitive substrate | NB-1 | Directive v4 section 4; R1; G1 | Fixed-version recurrent workspace plus deterministic offline train-only selection and a self-verifying, non-promoted model/provenance bundle; no gate is passed | Independent hidden-test artifact and run, contamination report, confidence-bound lift, accepted EVAL-01 report; broader G1 evidence still requires complete perception, inhibition, working-memory, and executive ablations |
...
| Neural Cognitive Workspace | NB-1 | Recognition NC-04; system boundary | Effect-free serial slice, immutable runtime model version, bounded offline training artifact, and hidden-evaluator interface implemented; NB-1 integration evidence is incomplete | Independent hidden recurrent-vs-stateless result, recurrence ablation, capacity and interference evidence, and accepted EVAL-01 report |
