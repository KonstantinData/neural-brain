...
def test_contract_inventory_covers_the_complete_cognitive_system() -> None:
    assert {path.name for path in CONTRACTS.glob("*.json")} == {
        ...
        "article-6-legal-basis-evidence-intake-v1.json",
        ...
        "privacy-notice-evidence-intake-v1.json",
        "processor-governance-evidence-intake-v1.json",
        "privacy-approval-record-v1.schema.json",
        "privacy-evidence-record-v1.schema.json",
        "protected-data-classification-v1.schema.json",
        "protected-storage-metadata-v1.schema.json",
        "protected-control-kill-switch-v1.json",
        ...
        "release-stops.json",
        "ropa-evidence-intake-v1.json",
        "scope-catalog.json",
        "security-floor-governance-v1.json",
        "special-category-data-runtime-enforcement-v1.json",
        "special-category-decision-record-v1.schema.json",
        "special-category-policy-state-machine-v1.json",
